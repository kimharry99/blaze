...
public class GeneratorObject : FurnitureObject
{
	public override FurnitureType type { get { return FurnitureType.Generator; } }
	...
	{
        GameManager.inst.StartTask(UseFurniture, 1);
    }
